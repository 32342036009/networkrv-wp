...
function oiopub_admin_links_settings($page='settings') {
	...
	echo "<br />\n";
	echo  htmlspecialchars("<?php if(function_exists('oiopub_link_zone')) oiopub_link_zone(" . $zone . ", 'center'); ?>") . "\n";
	echo "<br /><br />\n";
	...
	echo "<br />\n";
	echo htmlspecialchars('<script data-oio-zone="type=link&zone=' . $zone . '&align=center&refresh=0">') . "\n";
	echo "<br />\n";
