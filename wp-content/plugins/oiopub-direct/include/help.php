	...
	function output_funcs() {
		...
		if($this->show == "output") {
			...
			if(oiopub_links) {
				...
				echo "<div class='js_code'>\n";
				echo htmlspecialchars('<script data-oio-zone="type=link&zone=X&align=center&refresh=0">') . "\n";
				echo "<br />\n";
			...
			if(oiopub_banners) {
				...
				echo "Place this javascript code on any website you want to display ads on. Remember to replace 'X' with the zone number you want to show.\n";
				echo "<div class='js_code'>\n";
				echo htmlspecialchars('<script data-oio-zone="type=banner&zone=X&align=center&refresh=0">') . "\n";
				echo "<br />\n";
				echo htmlspecialchars('(function(w,d,e,o,u,s,t){w[o]||(w[o]={},s=d.createElement(e),s.src=u,s.async=1,') . "\n";
				echo "<br />\n";
				echo htmlspecialchars('t=d.getElementsByTagName(e)[0],t.parentNode.insertBefore(s,t))})(window,document,') . "\n";
