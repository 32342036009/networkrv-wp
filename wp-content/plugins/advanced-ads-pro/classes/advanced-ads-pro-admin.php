...
class Advanced_Ads_Pro_Admin {
	...
	add_filter('advanced-ads-overview-add-ons', array($this, 'overview_add_on_list'), 10, 2);
	...
	add_settings_section(
		Advanced_Ads_Pro::OPTION_KEY . '_modules-enable', __('Activate modules', 'advanced-ads-pro'), array($this, 'render_modules_enable'), Advanced_Ads_Pro::OPTION_KEY . '-settings'
	);

	// add new section
	add_settings_section(
		'advanced_ads_pro_settings_section', __('Other Settings', 'advanced-ads-pro'), array($this, 'render_other_settings'), Advanced_Ads_Pro::OPTION_KEY . '-settings'
	);
     ...
     *
     * @since 1.0.1
     * @updated 1.15.2 for new overview list api
     * 
     * @param $add_ons array with add-ons
     */
    public function overview_add_on_list( $add_ons ) {
