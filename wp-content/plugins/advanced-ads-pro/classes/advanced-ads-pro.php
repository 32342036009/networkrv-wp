...
class Advanced_Ads_Pro {
	...
	public function missing_plugin_notice(){
		echo '<div class="error"><p>' . sprintf( __( '<strong>Advanced Ads Pro</strong> is an extension for the Advanced Ads plugin. Please visit <a href="%s" target="_blank" >wpadvancedads.com</a> to download it for free.', 'advanced-ads-pro' ), 'https://wpadvancedads.com' ) . '</p></div>';
	}
