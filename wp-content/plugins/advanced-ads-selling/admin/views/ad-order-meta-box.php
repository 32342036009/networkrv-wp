<ul>
	...
	<?php if( $product->get_id() ) : ?><li><?php _e( 'Product' ); echo ': '; ?><a href="<?php echo get_edit_post_link( $product->get_id() ); ?>"><?php echo $product->get_title(); ?></a></li><?php endif; ?>
	<li><?php _e( 'Placement' ); echo ': ' . wc_get_order_item_meta( $item_id, '_ad_placement' ); ?></li>
