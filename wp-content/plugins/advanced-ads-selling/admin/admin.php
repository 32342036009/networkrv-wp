...
class Advanced_Ads_Selling_Admin {
	...
	public function wp_admin_plugins_loaded() {
	    ...
	    // add Ad Store widget to Advanced Ads overview dashboard
	    add_action( 'advanced-ads-overview-widgets-after', array($this, 'ad_store_widget') );
	...
	public function register_overview_page_widget() {
	    ...
	    $wp_meta_boxes['toplevel_page_advanced-ads']['side']['high']['advads_overview_addon_sellingads']['callback'][0] = 'Advanced_Ads_Selling_Admin';
	    $wp_meta_boxes['toplevel_page_advanced-ads']['side']['high']['advads_overview_addon_sellingads']['callback'][1] = 'render_overview_widget';
	}
	 ...
	 */
	public function ad_store_widget( $screen ){
		add_meta_box('advads_overview_store', __( 'Ad Store', 'advanced-ads-selling' ),
		array('Advanced_Ads_Selling_Admin', 'render_store_widget'), $screen->id, 'normal', 'high');
	}
	
	/**
	 * render store widget content
	 */
	public static function render_store_widget(){
