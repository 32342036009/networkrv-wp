...
class Advanced_Ads_Sticky_Admin {
	...
	*/
	public function missing_plugin_notice(){
		echo '<div class="error"><p>' . sprintf( __( '<strong>Advanced Ads – Sticky Ads</strong> is an extension for the Advanced Ads plugin. Please visit <a href="%s" target="_blank" >wpadvancedads.com</a> to download it for free.', 'advanced-ads-sticky' ), 'https://wpadvancedads.com' ) . '</p></div>';
	}
	...
	public function register_overview_page_widget(){
		...
		$wp_meta_boxes['toplevel_page_advanced-ads']['side']['high']['advads_overview_addon_sticky']['callback'][0] = 'Advanced_Ads_Sticky_Admin';
		$wp_meta_boxes['toplevel_page_advanced-ads']['side']['high']['advads_overview_addon_sticky']['callback'][1] = 'render_overview_widget';
	}
