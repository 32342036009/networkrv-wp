...
$target = ( isset( $ad_options['tracking']['link'] ) && !empty( $ad_options['tracking']['link'] ) )? $ad_options['tracking']['link'] : false;
global $post;
...
<ul>
    ...
    <?php if ( $target ) : ?>
    <?php if ( 'enabled' == $ad_options['tracking']['enabled'] || ( isset( $tracking_options['everything'] ) && 'true' == $tracking_options['everything'] && 'default' == $ad_options['tracking']['enabled'] ) ) : ?>
