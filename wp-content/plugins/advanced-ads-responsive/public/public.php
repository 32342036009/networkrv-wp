...
class Advanced_Ads_Responsive {
	...
	protected  $can_edit_ads = false;
		...
		if ( isset( $options[ AAR_SLUG ]['force-responsive-images'] ) && $options[ AAR_SLUG ]['force-responsive-images'] ) {
                        add_filter( 'advanced-ads-ad-image-tag-attributes', array( $this, 'force_responsive_images' ) );
                }
	}
	 ...
	 * 
	 * @since 1.3
	 * @param str $image_attributes existing image attributes
	 * $return str $image_attributes new image attributes
	 */
	public function force_responsive_images( $image_attributes ){
	    
	    return $image_attributes . ' style="max-width: 100%; height: auto;"';
