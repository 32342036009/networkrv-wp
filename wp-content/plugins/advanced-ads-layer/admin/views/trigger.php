<ul>
    ...
    <li>
	<label><input type="radio" name="<?php echo $option_name; ?>[trigger]" value="custom" <?php checked( $trigger, 'custom' ); ?>/><?php 
	printf( __( 'after user scrolled %s px', 'advanced-ads-layer' ), '<input type="number" name="' . $option_name . '[offset]" value="'.$offset.'"/>'); ?></label>
    </li>
