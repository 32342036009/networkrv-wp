...
<div>
    ...
    <div id="advads-layer-ads"<?php if ( ! $enabled ) : ?> style="display:none;"<?php endif; ?>>
        ...
        <ul>
            ...
            <li><label><input type="radio" name="advanced_ad[layer][trigger]" value="custom" <?php checked( $trigger, 'custom' ); ?>/></label><?php printf( __( 'after user scrolled %s px', 'advanced-ads-layer' ),
            '<input type="number" name="advanced_ad[layer][offset]" value="' . $offset . '"/>'); ?></li>
        </ul>
